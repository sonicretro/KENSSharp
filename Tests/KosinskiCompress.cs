namespace SonicRetro.KensSharp.Tests
{
    ...
    public static class KosinskiCompress
    {
        ...
        static KosinskiCompress()
        {
            ...
            AddDataItem(
                new byte[] { 0xDC, 0xDC, 0xDC },
                new byte[] { 0x41, 0x00, 0xDC, 0xFF, 0x00, 0xF0, 0x00 });
            AddDataItem(
                new byte[] { 0xDC, 0xDC, 0xDC, 0xDC, 0xDC, 0xDC, 0xDC },
                new byte[] { 0x15, 0x00, 0xDC, 0xFF, 0xFC, 0x00, 0xF0, 0x00 });
            AddDataItem(
                new byte[] { 0xDC, 0xFE },
            ...
            AddDataItem(
                new byte[] { 0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC, 0xFE, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB },
                new byte[] { 0xFF, 0xBF, 0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC, 0xFE, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB,
            ...
            AddDataItem(
                new byte[] { 0xDC, 0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    ...
                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                    0x00, 0xDC, 0xDC },
                new byte[] { 0x77, 0x01, 0xDC, 0xDC, 0x00, 0xFF, 0xF8, 0xFD, 0xDC, 0xDC, 0x00, 0xF0, 0x00 });
        }
